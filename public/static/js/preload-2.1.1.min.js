(function () {
  htmx.defineExtension("preload", {
    onEvent: function (e, t) {
      if (e === "htmx:afterProcessNode") {
        ...
        const r = [
          ...(n.hasAttribute("preload") ? [n] : []),
          ...n.querySelectorAll("[preload]"),
        ];
  ...
  function i(t) {
    ...
    if (t instanceof HTMLFormElement) {
      ...
      if (
        !(
          (o.hasAttribute("method") && o.method === "get") ||
          o.hasAttribute("hx-get") ||
          o.hasAttribute("hx-data-get")
        )
      ) {
        return;
      }
  ...
  function r(n) {
    ...
    if (p(n)) {
      const r =
        n.form.getAttribute("action") ||
        n.form.getAttribute("hx-get") ||
        n.form.getAttribute("data-hx-get");
  ...
  function g(e, t) {
    ...
    return (
      e.getAttribute(t) || e.getAttribute("data-" + t) || g(e.parentElement, t)
    );
  }
  function l(e) {
